...
export default function LoginCard() {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center p-4 relative overflow-hidden bg-background text-foreground">

            <div className="mb-8 text-center z-10">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-orange-500 shadow-lg shadow-red-600/30 mb-3 text-white">
            ...
            <Card className="w-full max-w-md rounded-3xl shadow-2xl p-8 z-10 bg-card text-card-foreground border-border">
                ...
                {error && (
                    <div className="mb-6 p-4 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 text-xs font-medium">
                        {error}
                    </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="mt-4 text-center">
                        <a href="/register" className="text-xs text-muted-foreground hover:text-red-400 transition-colors inline-block">
