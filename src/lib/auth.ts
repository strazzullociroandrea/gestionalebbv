    ...
    return betterAuth({
        ...
        plugins: [
            ...
            i18n({
                ...
                translations: {
                    it: {
                        USER_NOT_FOUND: "Non è stato trovato nessun utente con i dati forniti.",
                        INVALID_PASSWORD: "E' stata inserita una password non valida",
                        INVALID_EMAIL: "E' stata inserita una email non valida",
                        USER_ALREADY_EXISTS_USE_ANOTHER_EMAIL: "Esiste già un utente con questa email. Prova a utilizzare un'altra email.",
                        INVALID_OTP: "E' stato inserito un OTP non valido",
                        OTP_EXPIRED: "E' stato fornito un OTP scaduto",
