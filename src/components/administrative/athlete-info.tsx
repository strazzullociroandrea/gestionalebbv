...
export const AthleteInfo = ({idUser = "", idAthlete, emailUser: initialEmailUser}: AthleteInfoProps) => {
    ...
    const deleteAthleteMutation = api.administrative.deleteAthleteProfile.useMutation({
        onSuccess: async () => {
            setIsDeleteOpen(false);
            router.back();
        },
        onError: (err) => {
            setFormError(err.message || "Errore durante l'eliminazione dell'atleta.");
        }
    });
                ...
                <DialogContent
                    ...
                    <DialogHeader className="space-y-1">
                        ...
                        <DialogDescription className="text-xs text-zinc-500 font-medium">
                            Sei sicuro di voler eliminare questo atleta? L'azione è irreversibile.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <DialogFooter className="flex-col-reverse sm:flex-row gap-3 pt-4">
                        ...
                        <Button
                            type="button"
                            onClick={() => deleteAthleteMutation.mutate({id: idAthlete})}
                ...
                <CardContent className="p-4 sm:p-6 lg:p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div
                            ...
                            <InfoField icon={User} label="Nome" id="name" value={formData.name}
                            ...
                            <InfoField icon={Calendar} label="Data di Nascita" id="dateOfBirth"
                        ...
                        <div
                            className="space-y-4 sm:space-y-6 bg-zinc-50/50 p-4 sm:p-6 rounded-2xl border border-zinc-100">
                            <h3 className="text-base sm:text-lg font-bold text-zinc-900 mb-1 border-l-4 border-red-600 pl-3">Luogo
                                di Nascita</h3>
                            <InfoField icon={MapPin} label="Comune di Nascita" id="birthPlace"
                                       value={formData.birthPlace}
                                       handleChange={handleChange} isEditing={isEditing} required/>
                            <InfoField icon={Globe} label="Provincia (sigla)" id="countryBirthPlace"
                                       value={formData.countryBirthPlace} handleChange={handleChange}
                                       isEditing={isEditing}
                        ...
                        <div
                            ...
                            <InfoField icon={Calendar} label="Scadenza Certificato Medico"
